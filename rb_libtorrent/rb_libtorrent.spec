...
%define		Source0_sha1sum 3e461d9ede5fab3fb59be6a9f0cbc52121d536c4
...
%files	python
%defattr (-,root,root,0755)
%doc %attr(0644,-,-) bindings/python/{simple_,}client.py
%{python_sitearch}/python_libtorrent-%{version}-py?.?.egg-info
%{python_sitearch}/libtorrent.so


%changelog
* Mon Aug 05 2013 Arnoud Vermeer <a.vermeer@freshway.biz> 0.16.8-2
- Tito fix (a.vermeer@freshway.biz)

* Mon Aug 05 2013 Arnoud Vermeer <a.vermeer@freshway.biz> 0.16.9-1
...
- fixed spurious exec permissions of some example scripts in docs
